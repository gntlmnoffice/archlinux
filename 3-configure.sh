...
echo vulkan > /etc/hostname
sudo ln -sf /usr/share/zoneinfo/America/Sao_Paulo /etc/localtime

echo "Adding my user"
useradd -m -G wheel -s /bin/bash vitor && chmod +x /home/vitor
clear
passwd vitor
passwd root
chown -R vitor:vitor /home/vitor
chmod +x /home/vitor

git clone https://github.com/vulkan-ops/dotfiles /home/vitor/.dotfiles
